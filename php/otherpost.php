<?php
	...
	$sql="SELECT UP.uploadid,US.username,US.first_name,US.last_name,US.linktodp,UP.description,UP.path,UP.timestamp,UP.privacy 
		  ...
		  WHERE UP.username = US.username and US.username='$other' AND UP.privacy = 0
...
?>
	...
	{
	?>
		<center><b style="color:white;font-size:25px;">This user has not shared any posts publicly.</b></center>
	<?php
	}
	?>
