...
<?php
    ...
    $conn = mysqli_connect("localhost","root","","enable");
			if (!$conn)
  			{
    ...
    switch($action){
         case 'Approve': 
     	 ...
     	 case 'Reject': 
			      ...
			      $body="Hi, request by $mentor_name to  mentor $mentee_name is not approved.  was not approved. Please wait and try at a later point of time.";					
